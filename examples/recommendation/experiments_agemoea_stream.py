...
def experiments():
    ...
    folder_path = 'PycharmProjects/RecSysExp/experiment_output/moo/agemoea/stream/fold1/pop100'
    ...
    #file_path_save_solution = 'PycharmProjects/RecSysExp/experiment_output/moo/agemoea/stream/fold1/pop100'
    ...
    # AGEMOEA
    agemoea = AGEMOEAPyMoo(pop_size, top_n, num_features, time_termination, mutation, crossover, seed, experiment)
    folder_path = 'PycharmProjects/RecSysExp/experiment_output/moo/agemoea/stream/fold1/pop500'
    X, F = agemoea.recommend(features_in_memory_dict=train_features_in_memory_dict, metrics=metrics_to_use,
                           metric_params=metric_params, folder_path=folder_path)

    # DECISÃO MELHOR SOLUÇÃO
    weights_decision = np.array([0.5, 0.5])
    #file_path_save_solution = 'PycharmProjects/RecSysExp/experiment_output/moo/agemoea/stream/fold1/pop500'
    file_name_best_solution = f'experiment_{experiment}_best_solution.json'
    file_name_best_solution_result = f'experiment_{experiment}_best_solution_result.json'
    best_solution = decide_best_solution(X, F, weights_decision, folder_path, file_name_best_solution, file_name_best_solution_result)
    ...
    # AGEMOEA
    agemoea = AGEMOEAPyMoo(pop_size, top_n, num_features, time_termination, mutation, crossover, seed, experiment)
    folder_path = 'PycharmProjects/RecSysExp/experiment_output/moo/agemoea/stream/fold2/pop100'
    X, F = agemoea.recommend(features_in_memory_dict=train_features_in_memory_dict, metrics=metrics_to_use,
                           metric_params=metric_params, folder_path=folder_path)

    # DECISÃO MELHOR SOLUÇÃO
    weights_decision = np.array([0.5, 0.5])
    #file_path_save_solution = 'PycharmProjects/RecSysExp/experiment_output/moo/agemoea/stream/fold2/pop100'
    file_name_best_solution = f'experiment_{experiment}_best_solution.json'
    file_name_best_solution_result = f'experiment_{experiment}_best_solution_result.json'
    best_solution = decide_best_solution(X, F, weights_decision, folder_path, file_name_best_solution, file_name_best_solution_result)
    ...
    # AGEMOEA
    agemoea = AGEMOEAPyMoo(pop_size, top_n, num_features, time_termination, mutation, crossover, seed, experiment)
    folder_path = 'PycharmProjects/RecSysExp/experiment_output/moo/agemoea/stream/fold2/pop500'
    X, F = agemoea.recommend(features_in_memory_dict=train_features_in_memory_dict, metrics=metrics_to_use,
                           metric_params=metric_params, folder_path=folder_path)

    # DECISÃO MELHOR SOLUÇÃO
    weights_decision = np.array([0.5, 0.5])
    #file_path_save_solution = 'PycharmProjects/RecSysExp/experiment_output/moo/agemoea/stream/fold2/pop500'
    file_name_best_solution = f'experiment_{experiment}_best_solution.json'
    file_name_best_solution_result = f'experiment_{experiment}_best_solution_result.json'
    best_solution = decide_best_solution(X, F, weights_decision, folder_path, file_name_best_solution, file_name_best_solution_result)
    ...
    # AGEMOEA
    agemoea = AGEMOEAPyMoo(pop_size, top_n, num_features, time_termination, mutation, crossover, seed, experiment)
    folder_path = 'PycharmProjects/RecSysExp/experiment_output/moo/agemoea/stream/fold3/pop100'
    X, F = agemoea.recommend(features_in_memory_dict=train_features_in_memory_dict, metrics=metrics_to_use,
                           metric_params=metric_params, folder_path=folder_path)

    # DECISÃO MELHOR SOLUÇÃO
    weights_decision = np.array([0.5, 0.5])
    #file_path_save_solution = 'PycharmProjects/RecSysExp/experiment_output/moo/agemoea/stream/fold3/pop100'
    file_name_best_solution = f'experiment_{experiment}_best_solution.json'
    file_name_best_solution_result = f'experiment_{experiment}_best_solution_result.json'
    best_solution = decide_best_solution(X, F, weights_decision, folder_path, file_name_best_solution, file_name_best_solution_result)
    ...
    # AGEMOEA
    agemoea = AGEMOEAPyMoo(pop_size, top_n, num_features, time_termination, mutation, crossover, seed, experiment)
    folder_path = 'PycharmProjects/RecSysExp/experiment_output/moo/agemoea/stream/fold3/pop500'
    X, F = agemoea.recommend(features_in_memory_dict=train_features_in_memory_dict, metrics=metrics_to_use,
                           metric_params=metric_params, folder_path=folder_path)

    # DECISÃO MELHOR SOLUÇÃO
    weights_decision = np.array([0.5, 0.5])
    #file_path_save_solution = 'PycharmProjects/RecSysExp/experiment_output/moo/agemoea/stream/fold3/pop500'
    file_name_best_solution = f'experiment_{experiment}_best_solution.json'
    file_name_best_solution_result = f'experiment_{experiment}_best_solution_result.json'
    best_solution = decide_best_solution(X, F, weights_decision, folder_path, file_name_best_solution, file_name_best_solution_result)
    ...
    # AGEMOEA
    agemoea = AGEMOEAPyMoo(pop_size, top_n, num_features, time_termination, mutation, crossover, seed, experiment)
    folder_path = 'PycharmProjects/RecSysExp/experiment_output/moo/agemoea/stream/fold4/pop100'
    X, F = agemoea.recommend(features_in_memory_dict=train_features_in_memory_dict, metrics=metrics_to_use,
                           metric_params=metric_params, folder_path=folder_path)

    # DECISÃO MELHOR SOLUÇÃO
    weights_decision = np.array([0.5, 0.5])
    #file_path_save_solution = 'PycharmProjects/RecSysExp/experiment_output/moo/agemoea/stream/fold4/pop100'
    file_name_best_solution = f'experiment_{experiment}_best_solution.json'
    file_name_best_solution_result = f'experiment_{experiment}_best_solution_result.json'
    best_solution = decide_best_solution(X, F, weights_decision, folder_path, file_name_best_solution, file_name_best_solution_result)
    ...
    # AGEMOEA
    agemoea = AGEMOEAPyMoo(pop_size, top_n, num_features, time_termination, mutation, crossover, seed, experiment)
    folder_path = 'PycharmProjects/RecSysExp/experiment_output/moo/agemoea/stream/fold4/pop500'
    X, F = agemoea.recommend(features_in_memory_dict=train_features_in_memory_dict, metrics=metrics_to_use,
                           metric_params=metric_params, folder_path=folder_path)

    # DECISÃO MELHOR SOLUÇÃO
    weights_decision = np.array([0.5, 0.5])
    #file_path_save_solution = 'PycharmProjects/RecSysExp/experiment_output/moo/agemoea/stream/fold4/pop500'
    file_name_best_solution = f'experiment_{experiment}_best_solution.json'
    file_name_best_solution_result = f'experiment_{experiment}_best_solution_result.json'
    best_solution = decide_best_solution(X, F, weights_decision, folder_path, file_name_best_solution, file_name_best_solution_result)
    ...
    # AGEMOEA
    agemoea = AGEMOEAPyMoo(pop_size, top_n, num_features, time_termination, mutation, crossover, seed, experiment)
    folder_path = 'PycharmProjects/RecSysExp/experiment_output/moo/agemoea/stream/fold5/pop100'
    X, F = agemoea.recommend(features_in_memory_dict=train_features_in_memory_dict, metrics=metrics_to_use,
                           metric_params=metric_params, folder_path=folder_path)

    # DECISÃO MELHOR SOLUÇÃO
    weights_decision = np.array([0.5, 0.5])
    #file_path_save_solution = 'PycharmProjects/RecSysExp/experiment_output/moo/agemoea/stream/fold5/pop100'
    file_name_best_solution = f'experiment_{experiment}_best_solution.json'
    file_name_best_solution_result = f'experiment_{experiment}_best_solution_result.json'
    best_solution = decide_best_solution(X, F, weights_decision, folder_path, file_name_best_solution, file_name_best_solution_result)
    ...
    # AGEMOEA
    agemoea = AGEMOEAPyMoo(pop_size, top_n, num_features, time_termination, mutation, crossover, seed, experiment)
    folder_path = 'PycharmProjects/RecSysExp/experiment_output/moo/agemoea/stream/fold5/pop500'
    X, F = agemoea.recommend(features_in_memory_dict=train_features_in_memory_dict, metrics=metrics_to_use,
                           metric_params=metric_params, folder_path=folder_path)

    # DECISÃO MELHOR SOLUÇÃO
    weights_decision = np.array([0.5, 0.5])
    #file_path_save_solution = 'PycharmProjects/RecSysExp/experiment_output/moo/agemoea/stream/fold5/pop500'
    file_name_best_solution = f'experiment_{experiment}_best_solution.json'
    file_name_best_solution_result = f'experiment_{experiment}_best_solution_result.json'
    best_solution = decide_best_solution(X, F, weights_decision, folder_path, file_name_best_solution, file_name_best_solution_result)
