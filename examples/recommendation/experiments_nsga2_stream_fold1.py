...
def experiments():
    ...
    #FOLD 1--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    #PROCESSANDO FILES
    file_keys = '/home/usuario/PycharmProjects/RecSysExp/data_storage/stream/fold1/test.keys'
    file_test = '/home/usuario/PycharmProjects/RecSysExp/data_storage/stream/fold1/STREAM-all-test.skl'
    output_file_merged_test = '/home/usuario/PycharmProjects/RecSysExp/data_storage/stream/fold1/STREAM-all-test.merged'
